...
class TimeVariantSimulatorEnv(gym.Env):
    ...
    def __init__(self, env_params_dict=None):
        ...
        # self.CELX_df = _day(day_list = None, master_cell_records_dir = None, cell = None, file_prefix = 'MAST.CELX.')
    ...
    def _reset(self):
        ...
        # get a list of random training and test days
        if(self.TRAIN_MODE):
            self.CELX_df, day = random_train_day(day_list = self.train_days, master_cell_records_dir = self.timeseries_dir, cell = self.cell_id)
            print('TRAIN DAY ', day)
        else:
            self.CELX_df, day = random_train_day(day_list = self.test_days, master_cell_records_dir = self.timeseries_dir, cell = self.cell_id)
            print('TEST DAY ', day)
